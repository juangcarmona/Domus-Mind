...
reality:
  ...
  items:
    - "One person is already thinking about next Thursday."
    - "One person remembers the appointment before anyone mentions it."
    - "One person notices what is missing before anyone else does."
  summary: "If that person drops the thread, the house starts slipping."
breakdown:
  title: "Why normal tools still fail"
  items:
    - title: "Calendars show time."
      detail: "They do not show the work around it."
    - title: "Task apps show items."
      detail: "They do not show who already knows what matters."
    - title: "Chats and reminders move messages around."
      detail: "They do not create shared household clarity."
shift:
  title: "The shift"
  statement: "DomusMind turns scattered household memory into one shared household system."
  outcomes:
    - "What matters today becomes visible."
    - "Responsibility stops being implicit."
    - "The week makes sense before it becomes stressful."
proof:
  title: "What You See"
  primary:
    title: "Today"
  ...
  groups:
    ...
    - title: "Early access"
      items:
        ...
        - "Ongoing refinements to clarity and first-run flow"
earlyAccess:
